...
import { FilePenLine, ListOrdered, ShieldAlert, Info } from 'lucide-react';
    ...
    <div className="container mx-auto px-4 py-8">
      ...
      <section className="grid md:grid-cols-2 gap-8 mb-12 items-center">
        ...
        <Card className="shadow-lg hover:shadow-xl transition-shadow">
          ...
          <CardContent>
            <p className="text-foreground/80 mb-4">
              Our system provides transparent updates from case filing to investigation progress and resolution.
            </p>
          </CardContent>
          <CardFooter>
      ...
      <section className="text-center my-12 p-8 bg-card rounded-lg shadow-xl border border-destructive/50">
      ...
      <section className="mb-12">
        <Card className="bg-primary/5 border-primary/20">
          ...
          <CardContent className="space-y-4 text-foreground/80">
            <p><strong>1. Report:</strong> Fill out a simple form detailing the cybercrime incident and upload any supporting evidence.</p>
            <p><strong>2. AI Triage:</strong> Our advanced AI system automatically categorizes your report and assesses its urgency, prioritizing critical cases.</p>
            ...
            <p><strong>4. Stay Safe:</strong> Access resources and tips to protect yourself from future cyber threats.</p>
          </CardContent>
        </Card>
      </section>
    </div>
